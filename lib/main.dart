...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _uploadFileToGoogleDrive() async {
    ...
    List<ga.Permission> permissionList = [];
    ga.Permission permission = new ga.Permission.fromJson({"role":"writer", "type":"anyone"});
    //permission.role = "reader";
    //permission.type = "anyone";
    permissionList.add(permission);
    fileToUpload.permissions = permissionList;
  ...
  Future<void> _downloadGoogleDriveFile(String fName, String gdID) async {
    ...
    final saveFile = io.File('${directory.path}/${new DateTime.now().millisecondsSinceEpoch}$fName');
    List<int> dataStore = [];
